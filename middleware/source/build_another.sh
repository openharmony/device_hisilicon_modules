...
function main(){
    ...
    cp -rf $CUR_DIR/component/fileformat/ts/lib/$COMPILER/$OS_TYPE/libts.so $OUT_DIR/
    cp -rf $CUR_DIR/component/fileformat/exif/lib/$COMPILER/$OS_TYPE/libexif.so $OUT_DIR/
